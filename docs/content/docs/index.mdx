...
<Cards>
  <Card
    href="/docs/guide/instance"
    title="Instance"
    icon={<RiCodeSSlashLine />}
  >
    Describe the permission schema and create a Permix instance.
  </Card>
  <Card href="/docs/guide/setup" title="Setup" icon={<RiSettings3Line />}>
    Assign boolean or function rules for the current user.
  </Card>
  <Card href="/docs/guide/check" title="Check" icon={<RiShieldCheckLine />}>
    Check permissions with full type inference on paths and data.
  </Card>
  <Card href="/docs/guide/template" title="Template" icon={<RiFileCopyLine />}>
    Reusable role presets that stay in sync with the schema.
  </Card>
  <Card
    href="/docs/guide/hydration"
    title="Hydration"
    icon={<RiWaterFlashLine />}
  >
    Transfer rules from the server to the client for SSR.
  </Card>
  <Card href="/docs/guide/ready" title="Ready state" icon={<RiHourglassLine />}>
    Wait for permissions before rendering with `isReady()`.
  </Card>
  <Card href="/docs/guide/events" title="Events" icon={<RiBroadcastLine />}>
    React to `setup`, `ready`, and `check` with typed hooks.
  </Card>
  <Card href="/docs/guide/rebac" title="ReBAC" icon={<RiLinksLine />}>
    Relationship-based rules with closures and data-based checks.
  </Card>
</Cards>
