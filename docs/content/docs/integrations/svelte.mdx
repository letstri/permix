...
<Callout>
Before getting started with Svelte integration, make sure you've completed the initial setup steps in the [Quick Start](/docs/quick-start) guide. Svelte integration requires Svelte 5.
</Callout>
